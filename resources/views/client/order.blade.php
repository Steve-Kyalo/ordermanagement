                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input name="branch" id="branch" value="" type="text" class="form-control" maxlength="30" minlength="2" is-invalid placeholder="">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Job type</label>
                        <input name="jobtype" id="jobtype" value="" type="text" class="form-control" maxlength="30" minlength="2" is-invalid placeholder="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input name="no_of_devices" id="no_of_devices" value="" type="text" class="form-control" maxlength="30" minlength="2" is-invalid placeholder="">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Loan amount</label>
                        <input name="loan_amt" id="loan_amt" value="" type="text" class="form-control" maxlength="30" minlength="2" is-invalid placeholder="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input name="wiredlocation" id="wiredlocation" value="" type="text" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Wireless location</label>
                        <input name="wirelesslocation" id="wirelesslocation" value="" type="text" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>RO</label>
                        <input name="ro" id="ro" value="" type="text" class="form-control" placeholder="">
                      </div>
                    </div>
                  </div>
